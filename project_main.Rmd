...
# each year
regions <- dplyr::select(h16, Country, Region)
...
h17 <- h17 %>%
  ...
  merge(regions,by="Country", all.x=T) %>%
...
all_dat <- rbind.fill(h15,h16,h17,h18,h19)

# Need to fill in dystopia variable for 17~19
