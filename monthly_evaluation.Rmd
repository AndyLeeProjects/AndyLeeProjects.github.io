...
comp_dat <- rbind(comparison_month, month_dat) %>%
...
ggplot() +
  geom_line(data = comparison_month, aes(x = day(Date), y = Total, color = 'red')) +
  geom_line(data = month_dat, aes(x = day(Date), y = Total, color = 'blue')) +
  geom_smooth(data = comparison_month, aes(x = day(Date), y = Total, color = 'red'), alpha = .2) +
  geom_smooth(data = month_dat, aes(x = day(Date), y = Total, color = 'blue'), alpha = .2) + 
