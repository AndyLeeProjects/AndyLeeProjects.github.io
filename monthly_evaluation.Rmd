...
## Past 3 Months VS `r paste0(month.abb[previous_month])`  
...
summary_comparison = rbind(previous3_summary, month_summary)
...
pprevious_month = previous_month - 1
if(pprevious_month == 0){
  pprevious_month = 12
}
