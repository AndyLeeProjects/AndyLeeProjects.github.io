...
## Daily Evaluation Grading Metrics  
...
all_dat <- all_dat %>%
  select(Date, everything(), Finished, Total_todo,-X,-Name,-Created, - Work_done) %>%
...
save(month_dat, file = '/Volumes/Programming/Spring 2022/DANL 310/my_website/aLin-96.github.io/Grading_Scale/month_dat.RData')
