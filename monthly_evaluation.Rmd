...
ggplot(filter(summary.stats, variable %in% grading & !variable %in% multiple)) +
        geom_col(aes(x = month.abb[month], y = mean, group = variable, fill = variable), position = "dodge", alpha = .7) +
        geom_line(aes(x = month.abb[month], y = mean, group = variable, color = variable)) + 
        ylim(0,100) + 
...
g1 <- ggplot(filter(summary.stats, !variable %in% grading & !variable %in% multiple &
                      !variable %in% phone)) +
        geom_col(aes(x = month.abb[month], y = mean, group = variable, fill = variable), position = "dodge") +
...
g2 <- ggplot(filter(summary.stats, variable %in% phone)) +
        geom_smooth(aes(x = month.abb[month], y = mean, group = variable, color = variable)) +
...
g4 <- ggplot(filter(summary.stats, variable %in% multiple)) +
        geom_smooth(aes(x = month.abb[month], y = mean, group = variable, color = variable), position = "dodge") +
