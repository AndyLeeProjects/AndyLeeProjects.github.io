...
```{r, echo = TRUE, eval = TRUE, out.width = "1600px", fig.width = 12, fig.height = 6, fig.asp = .75, fig.align='center', warning = FALSE}
...
* The morning routine tasks:
  ...
  + Reading
  + Morning journal 
```{r, collapse=TRUE, out.width = "1600px", fig.width = 12, fig.height = 6, fig.asp = .75, fig.align='center', warning = FALSE}
