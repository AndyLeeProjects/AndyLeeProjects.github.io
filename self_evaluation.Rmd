...
# Use ifelse statement to create a new variable that differenciates the seasons
...
p7 <- ggplot(data = all_morning_rt) +
  geom_bar(aes(x = night_phone, fill = night_phone),
           alpha = .8, position = "dodge")+
  theme(legend.position = "None")

grid.arrange(p2, p3,p4,p5,p6,p7,p1, nrow = 4)
